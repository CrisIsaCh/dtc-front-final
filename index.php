...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-dark bg-dark">
      <a href="http://google.com" class="navbar-brand">ATENCIONES DTC MES DE NOVIEMBRE </a>
    </nav>
      ...
      <table id="tablaatenciones" class="table mt-2 table-bordered table-striped">
        <thead>
          <tr class="text-center">
            ...
            <th>USUARIO</th>
            <th>MOTIVO DE CONSULTA 1</th>
            <th>MOTIVO DE CONSULTA 2</th>
            <th>MOTIVO DE CONSULTA 3</th>
            <th>MOTIVO DE CONSULTA 4</th>
            <th>PROFESIONAL INTERVINIENTE</th>
            <th>SE ARTICULO CON</th>
            <th>COMENTARIOS</th>
            <th>ACCIONES</th>
          </tr>
        </thead>
 ...
 <div id="modalAtenciones" class="modal fade"  tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
