const url5='https://api-dtc-final.herokuapp.com/api/atenciones/';


const url ='https://api-dtc-final.herokuapp.com/api/mostrar/';
const contenedor = document.querySelector('tbody');
let resultados='';

const selectUsuario=document.getElementById('usuario');
//console.log(selectUsuario);
const url1 ='https://api-dtc-final.herokuapp.com/api/usuario/';
let resultados1='';

const selectProfesional=document.getElementById('profesional');
//console.log(selectProfesional);
const url2 ='https://api-dtc-final.herokuapp.com/api/profesionales/';
let resultados2='';

const selectMotivo=document.getElementById('motivo');
//console.log(selectMotivo);
const url3 ='https://api-dtc-final.herokuapp.com/api/motivo/';
let resultados3='';

const selectSearticulo=document.getElementById('seArticulo');
//console.log(selectMotivo);
const url4 ='https://api-dtc-final.herokuapp.com/api/searticulo/';
let resultados4='';
